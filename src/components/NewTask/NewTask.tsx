...
//     }
//   };
//   const selectAssignedUser = (user: any) => {
//     setAssignedUser(user); // store full object for UI
//     setAssignSearch(user.name); // show name in input
...
//     placeholder="Type to assign user"
//     value={assignSearch}
...
//         <li
//           key={user._id}
//           onClick={() => selectAssignedUser(user)}
//         >
//           {user.name}
//         </li>
//       ))}
